...
public class MainEstructurasTest {
    ...
    public static void main(String[] args) {
        ...
        ArbolNario<MetadatoArchivo> arbol = new ArbolNario<>(new MetadatoArchivo("Raiz", true, 0));
        NodoArbol<MetadatoArchivo> carpetaDocs = new NodoArbol<>(new MetadatoArchivo("Documentos", true, 0));
        NodoArbol<MetadatoArchivo> archivoTxt = new NodoArbol<>(new MetadatoArchivo(nombreArch1, false, tamanoArch1));
        ...
        NodoArbol<MetadatoArchivo> encontrado = arbol.buscarNodo(target);
        ...
        NodoArbol<MetadatoArchivo> nodoCarpeta = arbol.buscarNodo(targetCarpeta);
